...
function renderTaxInvoice(data) {
    ...
    <div style="text-align:center;margin-top:20px;">
        <button class="btn btn-primary" onclick="printTaxInvoice()">
            <i class="fas fa-print"></i> Print Tax Invoice
        </button>
        <button class="btn btn-success" onclick="shareWhatsAppTax()">
...
function printInvoice() {
    ...
    .tax-invoice-display{max-width:1000px;margin:0 auto}
